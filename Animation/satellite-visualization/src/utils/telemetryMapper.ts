import type { RawTelemetry, SatelliteState } from '../types/SatelliteState';
 ...
 * Useful for the developer override panel to update mock simulator states in raw format.
 */
